...
<template>
<Modal :show="open" size="large">
    <template #title>
        <div class="flex items-center space-x-2">
            <SvgIcons class="h-5" name="workshop" />
            <span class="font-medium">Panel Workshop</span>
        </div>
    </template>
    <template #body>
        <div class="p-4 mb-10">
                ...
                <div>
                    ...
                    <div class="flex space-x-2 mt-5">
                        <div>
                          ...
                          <div class="mt-1">
                            <input type="text" name="name" id="name" class="focus:ring-green-500 focus:border-green-500 block w-[300px] sm:text-sm border-gray-300 rounded" placeholder="Panel title">
                          </div>
                        </div>
                        <div>
                          <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                          <div class="mt-1">
                            <input type="text" name="description" id="description" class="focus:ring-green-500 focus:border-green-500 block w-[300px] sm:text-sm border-gray-300 rounded placeholder:text-gray-400 placeholder:text-xs" placeholder="What is the panel for?">
                          </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mt-5 grid grid-cols-7 gap-4">
                                <template v-for="widget in filteredWidgets">
                                    <div class="col-span-1">
                                        <div class="border border-slate-200 p-2 rounded hover:shadow transition-all cursor-pointer" :title="widget.name">
    ...
    <template #footer>
        <div class="w-full flex items-center justify-between">
            ...
            <CButton variant="success">Next &rarr;</CButton>
        </div>
    </template>
</Modal>
</template>
